...
const AllAppliedScholarship = () => {
    ...
    useEffect(() => {
        if (applications.length > 0) {
            ...
            setDisplayedApplications(sorted);
        }
    }, [applications, sortBy]);
    ...
    const fetchApplications = async () => {
        try {
            ...
            // Using the correct applications endpoint
            const response = await axios.get('https://server-kohl-pi.vercel.app/api/applications', {
                headers: {
    ...
    const handleFeedbackSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Refresh the applications list to ensure sync
                fetchApplications();
            } else {
    ...
    const handleCancel = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                const token = localStorage.getItem('access-token');
                await axios.patch(`https://server-kohl-pi.vercel.app/api/applications/${id}`, 
                    { 
                        status: 'rejected',
                        updatedAt: new Date(),
                        isReviewed: true
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-semibold mb-6 text-[#2C5F95]">All Applied Scholarships</h2>
                    ...
                    <div className="bg-white p-8 rounded-lg max-w-2xl w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p>{selectedApplication.scholarshipCategory}</p>
                            </div>
                            <div>
                                <p className="font-semibold">Subject Category:</p>
                                <p>{selectedApplication.subjectCategory}</p>
                            </div>
                            <div>
                            ...
                            <div className="col-span-2">
                                ...
                                <p>Total Paid: ${selectedApplication.payment?.totalPaid} ({selectedApplication.payment?.paymentStatus})</p>
                            </div>
                            <div>
